...
function AuthModal({ onClose, onSuccess }: { onClose: () => void; onSuccess: () => void }) {
  ...
  const showOAuthUnavailable = (provider: 'Google' | 'Apple') => {
    setError(`${provider} пока не подключён в Supabase. Используйте вход по email — он не требует OAuth credentials.`)
  }
